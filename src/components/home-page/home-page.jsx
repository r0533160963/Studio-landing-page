    ...
    return (
        <div className="home-page">
            <AppBar position="fixed" className="app-bar">
                <Toolbar>
                    <div className="appBar-action">
                        <img src="..\public\android-chrome-192x192.png" alt="logo" className="logo-image" onClick={() => scrollToSection('home-page')} />
            ...
            <div className="image-container" id="home-page">
                <img src="..\public\spicker-2.jpg" alt="A beautiful view" className="image-class" />
                {isCaptionVisible && (
            ...
            <div className="heder-end" id="contact-section">
                <img src="..\public\logo_yael-removebg-preview.png" className="logo-image-end" />
                <ContactPage />
            </div>
